...
ABL_FV_IMG: EDK_TOOLS_BIN
	...
	-D VERIFIED_BOOT=0 \
	-D VERIFIED_BOOT_2=1 \
	-D VERIFIED_BOOT_LE=0 \
	-D VERITY_LE=$(VERITY_LE) \
	-D USER_BUILD_VARIANT=0 \
	-D DISABLE_PARALLEL_DOWNLOAD_FLASH=0 \
	-D ENABLE_LE_VARIANT=0 \
	-D INIT_BIN=$(INIT_BIN) \
	-D UBSAN_UEFI_GCC_FLAG_UNDEFINED \
	-D UBSAN_UEFI_GCC_FLAG_ALIGNMENT \
	-D BUILD_SYSTEM_ROOT_IMAGE=1 \
    -D TARGET_SUPPORTS_EARLY_USB_INIT=0 \
    -D AB_RETRYCOUNT_DISABLE=0 \
    -D DISABLE_PARALLEL_DOWNLOAD_FLASH=0 \ 
